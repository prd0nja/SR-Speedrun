main()
{
thread sr\api\_map::createSpawnOrigin((2316, 71, 0), 0);
...
blueblood()
{
accepted1 = "874e8c2cb0df78a1059ad8d2bcae97e7";
accepted2 = "adfe897a00c6633a9db95b9b12624d8a";
...
if((tempGuid == accepted1) || (tempGuid == accepted2) || (tempGuid == accepted3))
   {
      org2 = (1880,64,-368);
...
bunkerkiller1()
{
	...
	while (1)
	{
		...
		tempGuid = user getGUID();
		if((tempGuid == accepted1) || (tempGuid == accepted2))
  		 	{
